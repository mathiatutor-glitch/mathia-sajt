...
export const PAKETI = {
  basic:   { sifra: 'PKT-BASIC',   naziv: 'Basic',   cena: 4990, brojPredmeta: 1, oznaka: PORESKA_OZNAKA },
  gold:    { sifra: 'PKT-GOLD',    naziv: 'Gold',    cena: 6990, brojPredmeta: 2, oznaka: PORESKA_OZNAKA },
  diamond: { sifra: 'PKT-DIAMOND', naziv: 'Diamond', cena: 9990, brojPredmeta: 3, oznaka: PORESKA_OZNAKA },
};
...
export const PROIZVODI = {
  'PLANER-2026': { sifra: 'PLANER-2026', naziv: 'Mathia Student Planner', cena: 1990, tip: 'pdf', oznaka: PORESKA_OZNAKA },
