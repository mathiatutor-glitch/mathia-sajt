...
const okvir = (sadrzaj, tagline) => `
  <div style="background:#FBF3EC;background:linear-gradient(180deg,#FBF3EC,#F3E7D3);padding:40px 16px;font-family:'Segoe UI',Arial,Helvetica,sans-serif">
    <div style="max-width:460px;margin:0 auto;background:#FCF9F3;border:1px solid #EBD9B3;border-radius:26px;padding:38px 36px;text-align:center;box-shadow:0 22px 55px rgba(120,70,80,.14);border-top:3px solid #C6A05C">
