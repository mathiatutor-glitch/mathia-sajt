...
export async function posaljiRacun({ to, racun, sta, pristupLink }) {
  const html = okvir(`
    ...
    <p><b>Stavka:</b> ${sta}${(racun && racun.brojRacuna) ? `<br><b>Fiskalni račun br.:</b> ${racun.brojRacuna}` : `<br><span style="color:#8B7680">Fiskalni račun stiže posebnim mejlom.</span>`}</p>
