...
"TIPOVI ZADATAKA: izračunavanje limesa (neodređeni oblici, Lopital), izvodi i primene, ispitivanje i crtanje toka funkcije, ekstremi (jedna i više promenljivih), tehnike integracije, primene integrala, rešavanje ODJ. " +
"Provere: K1 (granični procesi + izvodi), K2 (integrali + ODJ) + OBAVEZAN usmeni (teoreme). Tablice limesa/izvoda/integrala su alat. Objašnjavaj korak po korak, prvo intuicija pa postupak, sa rešenim primerom." },
...
"TIPOVI ZADATAKA: ravnoteža sistema sila i reakcije oslonaca (grede, nosači), rešetke; kinematika mehanizama i tela u ravnom kretanju; primena Njutnovih zakona i zakona održanja (energija/impuls); zadaci sa trenjem; oscilacije; moment inercije i rotacija. " +
"Objašnjavaj sa slikom/skicom, jasno razdvoji poznato/nepoznato, postavi jednačine ravnoteže ili kretanja, pa reši korak po korak; formule u $...$ LaTeX-u." },
];
