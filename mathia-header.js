...
(function () {
  ...
  function injectCss(){
    ...
    s.textContent =
      ...
      "#mhead .mh-brand{font-family:'Spectral',Georgia,serif;font-weight:700;font-size:1.5rem;letter-spacing:.14em;text-decoration:none;white-space:nowrap;background:linear-gradient(100deg,#9C7838,#E7D2A2 34%,#FFF7E2 50%,#E7D2A2 66%,#C6A05C);background-size:220% auto;-webkit-background-clip:text;background-clip:text;color:transparent;animation:mhFoil 9s linear infinite}@keyframes mhFoil{to{background-position:220% center}}" +
